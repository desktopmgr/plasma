...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202305051235-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, May 05, 2023 12:35 EDT
# @@File             :  install.sh
# @@Description      :  Install configurations for plasma
...
GLOBAL_OS_PACKAGES="xorg plasma plasma-desktop plasma-wayland-session kde-applications "
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Run custom actions
__cmd_exists plasmashell && unset GLOBAL_OS_PACKAGES DEBIAN_OS_PACKAGES UBUNTU_OS_PACKAGES
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
